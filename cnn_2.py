...
def create_time_series_classifier(input_shape, num_classes, dropout_rate=0.2):
    ...
    def conv_block(input_tensor, filters):
        ...
        x = Conv1D(filters=filters, kernel_size=15, padding='same', data_format="channels_last")(x)
...
for i in range(num_iterations):
    ...
    hist = model.fit(train_signals, train_labels, epochs=1500, batch_size=8, 
